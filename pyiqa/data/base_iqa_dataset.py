...
class BaseIQADataset(data.Dataset):
    ...
    def __getitem__(self, index):
        # img_path, mos_label = self.paths_mos[index]
        # light_info = self.text_meta_info[img_path]['light']
        # angle_info = self.text_meta_info[img_path]['angle']
        #
        # # Load and transform the image
        # img = load_image(img_path)  # load the image (function you would define elsewhere)
        # img_tensor = self.trans(img)  # apply transformations
        #
